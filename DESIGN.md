...
| No component showcase/Storybook | Web UI | Playwright E2E + vitest component tests cover the current surface area | Add if the component set grows enough that visual regressions become hard to catch by hand |
