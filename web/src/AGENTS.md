...
- ダッシュボードは single-screen 構成が仕様。Now playing、transport controls、volume slider、queue reorder/remove、YouTube playlist browser、import panel、post-import match review を1画面に収める（ルート `CLAUDE.md` の「Web UI scope」参照）
