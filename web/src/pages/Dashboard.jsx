...
import { useSavedPlaylists } from '../hooks/useSavedPlaylists.js'
...
export function Dashboard() {
  ...
  const savedPlaylists = useSavedPlaylists({ guildId, runAction })
  ...
  useEffect(() => {
    ...
    savedPlaylists.actions.refresh().catch(showError)
  }, [showError, savedPlaylists.actions.refresh])
  ...
  return (
    <main className="dashboard-shell">
      ...
      <div className="dashboard-grid">
        ...
        />
        <PlaylistBuilder
          state={{ ...savedPlaylists.state, busy }}
          actions={savedPlaylists.actions}
        />
      </div>
    </main>
  )
